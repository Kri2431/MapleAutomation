...
public class CustomSpinnerSelectStatus extends BaseAdapter {
    Context context;
    List<StstusModel.Datum> stateModels;
    LayoutInflater inflater;

    public CustomSpinnerSelectStatus(Context context, List<StstusModel.Datum> stateModels) {
