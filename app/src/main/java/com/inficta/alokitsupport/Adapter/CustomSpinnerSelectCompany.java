...
public class CustomSpinnerSelectCompany extends BaseAdapter {
    Context context;
    List<CompanyModel.Datum> stateModels;
    LayoutInflater inflater;

    public CustomSpinnerSelectCompany(Context context, List<CompanyModel.Datum> stateModels) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        txtCreatedBy.setText(stateModels.get(i).getCompanyName());
        return view;
    }
}
