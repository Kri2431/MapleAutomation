...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    Context context;
    List<SearchModel.Datum> mainCatModels;
    private OnItemClick onItemClick;

    public interface OnItemClick {
        void onClick(SearchModel.Datum mainCatModel);
    }

    public SearchAdapter(Context context, List<SearchModel.Datum> mainCatModels, OnItemClick onItemClick) {
